...
const market_structure_routes_1 = __importDefault(require("./routes/market-structure.routes"));
const support_resistance_routes_1 = __importDefault(require("./routes/support-resistance.routes"));
const trend_routes_1 = __importDefault(require("./routes/trend.routes"));
const momentum_routes_1 = __importDefault(require("./routes/momentum.routes"));
const volatility_routes_1 = __importDefault(require("./routes/volatility.routes"));
const multi_timeframe_routes_1 = __importDefault(require("./routes/multi-timeframe.routes"));
...
function createApp() {
    ...
    app.use('/api', market_structure_routes_1.default);
    app.use('/api', support_resistance_routes_1.default);
    app.use('/api', trend_routes_1.default);
    app.use('/api', momentum_routes_1.default);
    app.use('/api', volatility_routes_1.default);
    app.use('/api', multi_timeframe_routes_1.default);
