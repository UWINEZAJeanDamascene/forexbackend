...
export declare const CANONICAL_TIMEFRAME_STACK: Timeframe[];
...
export declare function analyzeMultiTimeframe(symbol: Symbol, analysisTimeframe: Timeframe, includeStack?: boolean): Promise<MultiTimeframeAnalysis>;
